...
public class WebUtil {
     ...
     */
    public static void renderString(HttpServletResponse response, String jsonMsg) {
        renderString(response, jsonMsg, 200);
    }
     ...
     * @param status   状态码
     */
    public static void renderString(HttpServletResponse response, String jsonMsg, Integer status) {
        try {
